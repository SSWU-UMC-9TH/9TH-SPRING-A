...
public class FoodExistValidator implements ConstraintValidator<ExistFoods, List<Long>> {
    ...
    private final FoodCategoryRepository foodRepository;
    ...
    public boolean isValid(List<Long> values, ConstraintValidatorContext context) {
        ...
        if (!isValid) {
            ...
            context.buildConstraintViolationWithTemplate(FoodCategoryErrorCode.CATEGORY_NOT_FOUND.getMessage()).addConstraintViolation();
        }
